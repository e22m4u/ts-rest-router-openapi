 ...
 * @param visible
 */
export function oaVisibility(visible) {
    return function (target, propertyKey, descriptor) {
        ...
        if (decoratorType !== DecoratorTargetType.CONSTRUCTOR &&
            ...
            throw new Error('@oaVisibility decorator is only supported ' +
                'on a class or an instance method.');
        }
        OAVisibilityReflector.setMetadata({ method: propertyKey, visible }, typeof target === 'function'
            ? target
